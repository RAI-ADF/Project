...
{    public $data = array(
                        ...
                        'pagination'    => '',
                        'tabel_data'    => '',
                        'main_view'     => 'peminjaman/peminjaman',
                        'form_action'   => '',
                        'form_value'    => '',
                        'option_kelas'  => '',
                         );
    ...
    public function tambah(){
        $this->data['breadcrumb']  = 'Peminjaman > Tambah';
        $this->data['main_view']   = 'peminjaman/pinjam_form';
        $this->data['form_action'] = 'Peminjaman/tambah';
		$this->load->view('utama', $this->data);
        
        if($this->input->post('submit'))
        {
            $this->load->model('p_Pinjam');
			$this->p_Pinjam->insert_data(); 
			//redirect('home');
        }
    }
