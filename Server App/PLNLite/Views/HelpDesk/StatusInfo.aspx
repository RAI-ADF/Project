<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusInfo.aspx.cs" Inherits="PLNLite.Views.HelpDesk.StatusInfo" %>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string tiket = CryptographEngine.Decrypt(Session["ticket"].ToString(), true);
            Session["status"] = null;
            ...
            {
                Session["status"] = GetStatus(data[0].ToString());
            }
        }
    }
...
<section class="single-single-post-section page-section white-bg">
	...
	<div class="row">
		<article class="col-md-12 text-left">
				...
				<h1><span class="color"><strong>Status Ticket</strong></span></h1>
				<h6><span class="color"><strong><br />By Ticket Number Bellow</strong></span></h6>
                <h1><span class="color"><strong><% if (Session["ticket"] != null) Response.Write(CryptographEngine.Decrypt(Session["ticket"].ToString(), true)); Session["ticket"] = null; %></strong></span></h1>
				<h3><span class="color"><strong><br /><% if (Session["status"] != null) Response.Write(Session["status"].ToString()); Session["status"] = null; %><br /></strong></span></h3>
