<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Information.aspx.cs" Inherits="PLNLite.Views.HelpDesk.Information" %>
	            ...
	            <div class="row">
		            <article class="col-md-12 text-left">
		                <div class="single-post-area-inner text-center">
				            <h5><span class="color">Thank You<strong></strong></span></h5>
				            <h6><span class="color"><strong>We got your message. <br /> You will received the ticket number as below on your email to follow up your report. <br /></strong></span></h6>
				            ...
				            <h6><span class="color"><strong>we will get back to you soon to follow up your request. </strong></span></h6>
