<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="PLNLite.Views.HelpDesk.Status" %>
...
<script runat="server">
    ...
    {
        object[] data = CatalogHelpDesk.GetAduanByTiket(txtTicket.Text);
        ...
        else
        {
            ...
            Response.Redirect("StatusInfo.aspx");
        }
    }
</script>
<html lang="en">
...
<section class="single-single-post-section page-section white-bg">
	...
	<div class="row">
            <div class="single-post-area-inner text-center">
                <h5><span class="color">Status Form<strong></strong></span></h5>
                <h6><span class="color">Please submit by entry your <strong> Ticket Number</strong></span></h6><br />
                <div class="row">
                    <form class="form-horizontal" runat="server">
                        ...
                        <div class="single-post-proceed">
                            <asp:LinkButton ID="btnSUbmit" runat="server" class="btn btn-presence btn-presence-dark" OnClick="btnSUbmit_Click" Text="Okay Search"></asp:LinkButton>
