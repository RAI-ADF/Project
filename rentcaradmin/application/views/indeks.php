...
<html lang="en">
  <head>
    ...
    <!-- owl carousel -->
    <link rel="<?=base_url();?>stylesheet" href="css/owl.carousel.css" type="text/css"/>
	<link href="<?=base_url();?>css/jquery-jvectormap-1.2.2.css" rel="stylesheet"/>
    <!-- Custom styles -->
	<link rel="<?=base_url();?>stylesheet" href="css/fullcalendar.css"/>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?=base_url()?>tambah">Input Data Mobil</a></li>                          
                          <li><a class="" href="<?=base_url()?>tampil">Lihat Data Mobil</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="general.html">Input Data User</a></li>
                          <li><a class="" href="buttons.html">Lihat Data User</a></li>
            ...
            <div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box blue-bg">
						...
						<div class="title">Total mobil siap pakai</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="title">Total supir yang dimiliki</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->	
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box dark-bg">
						...
						<div class="title">Total user aktif saat ini</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
